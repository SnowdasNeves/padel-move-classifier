...
def about():
    ...
    st.write("""
             ...
             machine learning algorithm, trained by professional WPT
             player João Nunes! It uses a Random Forest classifier as we
    ...
    if st.toggle('See Normal GIF'):
        gif_dir = r'C:\Users\diogo\Documents\aai_projeto\communication\images_for_web\Normal.gif'
    ...
    if st.toggle('See Backhand GIF'):
        gif_dir = r'C:\Users\diogo\Documents\aai_projeto\communication\images_for_web\Backhand.gif'
        with open(gif_dir, "rb") as gif_file:
            base64_encoded = base64.b64encode(gif_file.read()).decode()
    ...
    if st.toggle('See Smash GIF'):
        gif_dir = r'C:\Users\diogo\Documents\aai_projeto\communication\images_for_web\Smash.gif'
        with open(gif_dir, "rb") as gif_file:
            base64_encoded = base64.b64encode(gif_file.read()).decode()
    ...
    if st.toggle('See Lob GIF'):
        gif_dir = r'C:\Users\diogo\Documents\aai_projeto\communication\images_for_web\Lob.gif'
        with open(gif_dir, "rb") as gif_file:
            base64_encoded = base64.b64encode(gif_file.read()).decode()
    ...
    if st.toggle('See Bandeja GIF'):
        gif_dir = r'C:\Users\diogo\Documents\aai_projeto\communication\images_for_web\Bandeja.gif'
        with open(gif_dir, "rb") as gif_file:
            base64_encoded = base64.b64encode(gif_file.read()).decode()
...
def connection():
    ...
    st.session_state['MyData']['TopicSub'] = st.text_input('Topic subscribed: ', value='AAI/padel/data')
